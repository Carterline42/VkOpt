...
var vkopt_core = {
    ...
    dom_ready: function (fn, ctx) {
        ...
        themeUiSwitcherDarkVkWorker();
        if (vkopt.settings.get('trackUserTheme')) {
            setInterval(themeUiSwitcherDarkVkWorker, 1000);
        }
    ...
    css: function () {
        return vk_lib.get_block_comments(function () {
            ...
            .vk_lang a{
               ...
               padding:2pt 5pt;
               margin:2pt;
               border_: var(--vdusv-tile-border);
               background: var(--vdusv-tile-def);
               width:100pt;
               height:50pt;
            }
            .vk_lang a.selected{
               background-color: var(--vdusv-tile-selected);
            }
            .vk_lang a{
            ...
            .vk_lang a:hover, .vk_lang a:focus, .vk_lang a.selected:hover{
               ...
               color:#fff;
               background: var(--vdusv-tile-hover);
            }
    ...
    css: function () {
        return vk_lib.get_block_comments(function () {
            ...
            .vk_menu_block ul{
               ...
               margin: 2px;
               padding: 0px;
               background: var(--vdusv-left-panel);
               border-radius:5px;
               box-shadow: var(--vdusv-specborder);
               overflow:hidden;
            }
            ...
            .vk_menu_block ul li a:hover{
               background: var(--vdusv-left-panel-item-hover);
            }
    ...
    css: function () {
        return vk_lib.get_block_comments(function () {
            ...
            .vk_msg_info_icon{
               ...
               float: right;
               margin: 14px;
               -webkit-filter: var(--vdusv-ext-icons-fill);
               filter: var(--vdusv-ext-icons-fill);
            }
            ...
            .vk_au_msg_recognize{
               ...
               line-height: 20px;
               color: #4a76a8;
               background: var(--vdusv-vk_au_msg_recognize-bg);
               text-align: center;
            ...
            .vk_au_msg_recognize_txt{
               ...
               margin-top: 10px;
               padding: 3px 10px;
               background: var(--vdusv-vk_au_msg_recognize_txt);
               border-radius: 10px;
               display: none;
            }
            .vk_au_msg_recognize_txt:before{
               ...
               border-bottom: 6px solid var(--vdusv-vk_au_msg_recognize_txt);
            }
...
vkopt['face'] = {
    ...
    css: function () {
        var codes = vk_lib.get_block_comments(function () {
            ...
            .vkUOnline {
               background-color: var(--vdusv-vk_online_status-online);
            }
            .vkUOffline {
               background-color: var(--vdusv-vk_online_status-offline);
            }
            .vkUUndef {
               background-color: var(--vdusv-vk_online_status-undef);
            }
        ...
        var code = vk_lib.get_block_comments(function () {
            ...
            */
            ...
            .post_dislike_icon{
               ...
               margin-top: 1px;
               opacity: 0.35;
               -webkit-filter: var(--vdusv-ext-icons-fill-contrase);
               filter: var(--vdusv-ext-icons-fill-contrast);
            }
